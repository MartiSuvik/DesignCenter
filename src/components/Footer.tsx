  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        'https://hook.eu2.make.com/bacg3hrdyiut5xeu2hrjefdyy4kgqnct',
        {
          method: 'POST',
          headers: {
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <img
              ...
              className="w-auto h-[60px] max-w-[120px] object-contain"
            />
          </Link>
          ...
          <div className="flex items-center space-x-6">
            <button
              ...
              data-footer-contact
              className="px-6 py-2 bg-[#C5A267] hover:bg-[#B49157] text-white text-sm font-medium font-serif rounded-lg transition-all duration-200 flex items-center space-x-2"
            >
              <span>CONTACT</span>
              {isExpanded ? (
            ...
            <button
              ...
              className="hidden md:flex items-center space-x-2 font-serif text-sm text-gray-600 hover:text-black transition-colors duration-200 group"
            >
